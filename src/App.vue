...
<template> <form v-on:submit.prevent="saveItem" class="add-item form"> 
...
<label> 
  ...
  {{ newItemHighPriority ? "🔥" : "🧊" }} 
  <!-- Boton de UI --> 
  <button class="btn btn-primary">Salvar Articulo
  ...
  <ul> 
    ...
    <style scoped> 
    .shopping-cart-icon { font-size: 2rem; /* Adjust the font-size value as per your desired size */ } 
    </style>